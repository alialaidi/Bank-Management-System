...
public:
	...
	clsDate(string sDate)
	{
		...
		vector <string> vDate;
		vDate = clsString::vSplitFunc(sDate, "/");
   ...
   void Print()
	...
	{
        Date.SetYear(Date._Year+(Decade*10));
		return Date;
	}
	...
	{
        Date.SetYear(Date._Year-(Decades *10));
		return Date;
	}
