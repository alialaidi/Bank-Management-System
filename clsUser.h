...
class clsUser : public clsPerson
{
    ...
    static  vector <clsUser> _LoadUsersDataFromFile()
    {
        ...
        fstream MyFile;
        MyFile.open("File2_Users.txt", ios::in);//read Mode
    ...
    static void _SaveUsersDataToFile(vector <clsUser> vUsers)
    {
        ...
        fstream MyFile;
        MyFile.open("File2_Users.txt", ios::out);//overwrite
    ...
    {
        fstream MyFile;
        MyFile.open("File2_Users.txt", ios::out | ios::app);
    ...
    bool CheckAccessPermission(enPermissions Permissions)
    {
        ...
        if ((Permissions & this->GetPermissions()) == Permissions)
        return true;
        else
        return false;
    }
    ...
    void RegisterLogin()
    {
        ...
        fstream MyFile;
        MyFile.open("File3_LoginRegister.txt", ios::out | ios::app);
    ...
    static  vector <stLoginRegisterRecord> GetLoginRegisterList()
     {
         ...
         fstream MyFile;
         MyFile.open("File3_LoginRegister.txt", ios::in);//read Mode
